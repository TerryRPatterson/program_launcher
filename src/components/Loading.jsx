...
let Logo = () => {
    return <svg version="1.1" id="Layer_2_1_" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
let Loading = () => {
    ...
    return <svg width="200px"  height="200px"  xmlns="http://www.w3.org/2000/svg"
        ...
        <circle cx="50" cy="50" ng-attr-r="{{config.radius}}"
            ng-attr-stroke-width="{{config.width}}" ng-attr-stroke="{{config.c1}}"
